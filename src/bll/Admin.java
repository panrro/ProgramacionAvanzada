...
public class Admin extends Usuario {
	...
	public static boolean agregarDoctor() {
	    Usuario.agregarUsuario(); // crea el usuario
	    ...
	    int idElegido = JOptionPane.showOptionDialog(null, "Seleccione especialidad", null, 0, 0, null, especialidades, especialidades[0]);
	    idElegido++; 
	    ...
	    int idElegidoObraSocial = JOptionPane.showOptionDialog(null, "Seleccione obra social", null, 0, 0, null, obrasSociales, obrasSociales[0]);
	    idElegidoObraSocial++; 
